...
class OrderRefundController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'OrderRefund');
	...
	public function actionCreate() 
	{
		...
		if (isset($_POST['OrderRefund'])) {
			$model->setAttributes($_POST['OrderRefund']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'OrderRefund')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('OrderRefund');
	...
	public function actionSearch()
	{
		...
		{
			$model->setAttributes($_GET['OrderRefund']);
