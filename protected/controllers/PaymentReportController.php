...
class PaymentReportController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'PaymentReport');
	...
	public function actionCreate() 
	{
		...
		if (isset($_POST['PaymentReport'])) {
			$model->setAttributes($_POST['PaymentReport']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'PaymentReport')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('PaymentReport');
	...
	public function actionSearch()
	{
		...
		{
			$model->setAttributes($_GET['PaymentReport']);
