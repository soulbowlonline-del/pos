...
class EmpShiftController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'EmpShift');
	...
	public function actionCreate() 
	{
		...
		if (isset($_POST['EmpShift'])) {
			$model->setAttributes($_POST['EmpShift']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'EmpShift')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('EmpShift');
	...
	public function actionSearch()
	{
		...
		if (isset($_GET['EmpShift']))
		{
			$model->setAttributes($_GET['EmpShift']);
