...
class BillController extends GxController {
	...
	public function actionCreate($id) 
	{
		...
		if (isset($_POST['Bill'])) {
			$model->setAttributes($_POST['Bill']);
			$model->po_id = $id;
