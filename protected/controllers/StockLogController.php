...
class StockLogController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'StockLog');
	...
	public function actionCreate() 
	{
		...
		if (isset($_POST['StockLog'])) {
			$model->setAttributes($_POST['StockLog']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'StockLog')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('StockLog');
	...
	public function actionSearch()
	{
		...
		{
			$model->setAttributes($_GET['StockLog']);
