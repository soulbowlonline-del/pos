...
class AdvanceLogsController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'AdvanceLogs');
	...
	public function actionCreate() 
	{
		...
		if (isset($_POST['AdvanceLogs'])) {
			$model->setAttributes($_POST['AdvanceLogs']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'AdvanceLogs')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('AdvanceLogs');
	...
	{
		$model = new AdvanceLogs ('search');
		$model->unsetAttributes();
		$this->updateMenuItems($model);
	
		if (isset($_GET['AdvanceLogs']))
		{
			$model->setAttributes($_GET['AdvanceLogs']);
