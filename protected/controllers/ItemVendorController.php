...
class ItemVendorController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'ItemVendor');
	...
	public function actionCreate() 
	{
		...
		if (isset($_POST['ItemVendor'])) {
			$model->setAttributes($_POST['ItemVendor']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'ItemVendor')->delete();

			if (!Yii::app()->getRequest()->getIsAjaxRequest())
				$this->redirect(array('item/vendor','id'=>$item_id));
		} else
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('ItemVendor');
	...
	public function actionSearch()
	{
		...
		{
			$model->setAttributes($_GET['ItemVendor']);
