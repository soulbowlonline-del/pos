...
class PaymentModeController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'PaymentMode');
	...
	public function actionCreate() 
	{
		...
		if (isset($_POST['PaymentMode'])) {
			$model->setAttributes($_POST['PaymentMode']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'PaymentMode')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('PaymentMode');
	...
	public function actionSearch()
	{
		...
		{
			$model->setAttributes($_GET['PaymentMode']);
