...
class OrderRefundItemController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'OrderRefundItem');
	...
	public function actionCreate() 
	{
		...
		if (isset($_POST['OrderRefundItem'])) {
			$model->setAttributes($_POST['OrderRefundItem']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'OrderRefundItem')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('OrderRefundItem');
	...
	public function actionSearch()
	{
		...
		{
			$model->setAttributes($_GET['OrderRefundItem']);
