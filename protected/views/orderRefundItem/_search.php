...
?>
	...
	<div class="row">
		<?php echo $form->label($model, 'order_refund_id'); ?>
		<?php echo $form->dropDownList($model, 'order_refund_id', GxHtml::listDataEx(OrderRefund::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'discount_id', GxHtml::listDataEx(Discount::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model, 'tax_amt'); ?>
		<?php echo $form->textField($model, 'tax_amt'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'order_discount'); ?>
		<?php echo $form->textField($model, 'order_discount'); ?>
	</div>
