<div class="view">
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('order_refund_id')); ?>:
		<?php echo GxHtml::encode(GxHtml::valueEx($data->orderRefund)); ?>
	<br />
	...
	<?php echo GxHtml::encode($data->getAttributeLabel('discount_id')); ?>:
		<?php echo GxHtml::encode(GxHtml::valueEx($data->discount)); ?>
	<br />
	<?php /*
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('tax_amt')); ?>:
	<?php echo GxHtml::encode($data->tax_amt); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('order_discount')); ?>:
	<?php echo GxHtml::encode($data->order_discount); ?>
	<br />
