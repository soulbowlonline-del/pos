								...
								align="center" bgcolor="#FFFFFF" border="0" cellpadding="0"
										cellspacing="0"
												...
												<td align="left"
														...
														<?php $vendor = Vendor::model()->findByAttributes(array('id'=>$mrnmodel->vendor_id));
														if($vendor){
															$user = User::model()->findByAttributes(array('id'=>$mrnmodel->create_user_id));
														}
														?>
														<p
														...
														$link = Yii::app()->createAbsoluteUrl('mrnDetail/admin');
														?>,</p>
														<p
															style="font-size: 14px; color: #333333; line-height: 32px; ">
															A new mrn is added :</p>
