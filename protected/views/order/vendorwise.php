...
<section class="content-header">
	...
	<h1><?php echo Yii::t('app', 'VendorwiseWise Report'); ?></h1>
</section>
	...
	<div class="modal-dialog">
     ...
     <?php
					...
					$form = $this->beginWidget ( 'bootstrap.widgets.TbActiveForm', array (
							...
							'type' => 'horizontal',
							'action' => Yii::app ()->createUrl ( 'order/vendorWiseExport?exportCSV=1' ),
...
<?php $this->widget ( 'bootstrap.widgets.TbExtendedGridView', array (
	...
	'columns' => array(
		...
		'name',
			 array (
					'header' => 'Sale Amount',
					'value' => '$data->getVendorSaleTotalAmount()',
					//'footer'=>$cat_total
			),
			array (
					'header' => 'Sale Tax',
					'value' => '$data->getVendorSaleTaxAmount()',
					//'footer'=>$cat_total
			),
			array (
					'header' => 'Purchase Amount',
					'value' => '$data->getVendorPurchaseTotalAmount()',
					//'footer'=>$cat_total
			),
			array (
					'header' => 'Margin',
					'value' => '$data->getVendorPurchaseMargin()',
					//'footer'=>$cat_total
			),
			array (
					'header' => 'Purchase Tax',
					'value' => '$data->getVendorPurchaseTaxAmount()',
					//'footer'=>$cat_total
			),
			array (
					'header' => 'Discount',
					'value' => '$data->getVendorDiscountAmount()',
					//'footer'=>$cat_total
			),
		/* 	array(
					'header' => 'Parent',
