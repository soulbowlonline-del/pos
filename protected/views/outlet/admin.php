...
<?php    $this->widget('bootstrap.widgets.TbMenu', array(
       ...
       'items' => array(
        		array('label' => 'Export',
        				'url' => array('outlet/admin' ,'exportCSV'=>'1',
...
array(
		...
		'buttons'=>array(
				'view'=>array(
						...
						'url' =>'Yii::app()->controller->createUrl("outlet/view", array("id" => $data->id))',
						'label'=>'View',
						'options'=>array('class'=>'view'),
							
				),
				'update'=>array(
						'visible'=>'$data->checkPermission ("outlet/update")=="true"',
						'url' =>'Yii::app()->controller->createUrl("outlet/update", array("id" => $data->id))',
						'label'=>'Update',
