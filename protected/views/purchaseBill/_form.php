...
<?php echo $form->radioButtonListRow($model, 'purchase_order_id', GxHtml::listDataEx(PurchaseOrder::model()->findAllAttributes(null, true))); ?>
...
<?php if ( count (PurchaseBillDetail::model()->findAllAttributes(null, true) ) > 0 ): ?>
		<label><?php echo GxHtml::encode($model->getRelationLabel('purchaseBillDetails')); ?></label>
	
		<?php echo $form->checkBoxListRow($model, 'purchaseBillDetails', GxHtml::encodeEx(GxHtml::listDataEx(PurchaseBillDetail::model()->findAllAttributes(null, true)), false, true)); ?>
<?php endif; ?>	
