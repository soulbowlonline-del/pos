...
<?php   /*  $this->widget('bootstrap.widgets.TbMenu', array(
       ...
       'items' => array(
        		array('label' => 'Export',
        				'url' => array('tax/admin' ,'exportCSV'=>'1',
	...
	<div class="modal-dialog">
     ...
     <?php
					...
					$form = $this->beginWidget ( 'bootstrap.widgets.TbActiveForm', array (
							...
							'type' => 'horizontal',
							'action' => Yii::app ()->createUrl ( 'tax/admin?exportCSV=1' ),
	...
	'columns' => array(
		...
		*/
			array(
					...
					'buttons'=>array(
							'view'=>array(
									'visible'=>'$data->checkPermission ("tax/view")=="true"',
									'url' =>'Yii::app()->controller->createUrl("tax/view", array("id" => $data->id))',
									'label'=>'View',
									'options'=>array('class'=>'view'),
										
							),
							'update'=>array(
									'visible'=>'$data->checkPermission ("tax/update")=="true"',
									'url' =>'Yii::app()->controller->createUrl("tax/update", array("id" => $data->id))',
									'label'=>'Update',
