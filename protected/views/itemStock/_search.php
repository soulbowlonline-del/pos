...
?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model, 'batch_number', array('maxlength' => 255)); ?>
	</div>
...
; ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'tax_id', GxHtml::listDataEx(Tax::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
