...
<?php    $this->widget('bootstrap.widgets.TbMenu', array(
       ...
       'items' => array(
        		array('label' => 'Export',
        				'url' => array('organization/admin' ,'exportCSV'=>'1',
...
array(
		...
		'buttons'=>array(
				'view'=>array(
						'visible'=>'$data->checkPermission ("organization/view")=="true"',
				...
				'update'=>array(
						'visible'=>'$data->checkPermission ("organization/update")=="true"',
						'url' =>'Yii::app()->controller->createUrl("organization/update", array("id" => $data->id))',
						'label'=>'Update',
