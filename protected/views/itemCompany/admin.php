...
<?php    $this->widget('bootstrap.widgets.TbMenu', array(
       ...
       'items' => array(
        		array('label' => 'Export',
        				'url' => array('itemCompany/admin' ,'exportCSV'=>'1',
			...
			array(
					...
					'buttons'=>array(
							'view'=>array(
									...
									'url' =>'Yii::app()->controller->createUrl("ItemCompany/view", array("id" => $data->id))',
									'label'=>'View',
							...
							'update'=>array(
									...
									'url' =>'Yii::app()->controller->createUrl("ItemCompany/update", array("id" => $data->id))',
									'label'=>'Update',
