...
<?php    $this->widget('bootstrap.widgets.TbMenu', array(
       ...
       'items' => array(
        		array('label' => 'Export',
        				'url' => array('itemCompany/subcompany' ,'exportCSV'=>'1',
	...
	/* 	array(
		...
		*/
			array(
					...
					'buttons'=>array(
							'view'=>array(
									'visible'=>'$data->checkPermission ("ItemCompany/view")=="true"',
									'url' =>'Yii::app()->controller->createUrl("ItemCompany/subView", array("id" => $data->id))',
									'label'=>'View',
									'options'=>array('class'=>'view'),
										
							),
							'update'=>array(
									'visible'=>'$data->checkPermission ("ItemCompany/update")=="true"',
									'url' =>'Yii::app()->controller->createUrl("ItemCompany/subUpdate", array("id" => $data->id))',
									'label'=>'Update',
