	...
	<div class="modal-dialog">
     ...
     <?php
					...
					$form = $this->beginWidget ( 'bootstrap.widgets.TbActiveForm', array (
							...
							'type' => 'horizontal',
							'action' => Yii::app ()->createUrl ( 'b2bpurchaseBill/userWiseExport?exportCSV=1' ),
	...
	'columns' => array(
		//'id',
			...
			array(
					...
					'value'=>'$data->getTotalUserwiseGrossAmount()',
				//	'footer'=>$gross_total
					//'filter'=>Order::getStatusOptions(),
			),
			...
			array(
					...
					'value'=>'$data->getTotalB2bUserwiseGrossAmountData()',
				
			),
	    
	    array(
	        'header' => '<a>Total Refund Amount</a>',
	        'value'=>'$data->getUserTotalRefundAmountData()',
	        
	    ),
	    
	    array(
	        'header' => '<a>Total Discount Amount</a>',
	        'value'=>'$data->getUserTotalDiscountAmountData()',
			...
			array(
					...
					'value'=>'$data->getTotalUserwiseNetAmountData()',
