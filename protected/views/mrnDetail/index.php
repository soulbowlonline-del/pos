...
$form = $this->beginWidget ( 'bootstrap.widgets.TbActiveForm', array (
		...
		'action' => Yii::app ()->createUrl ( 'mrnDetail/index', array (
				'id' => $user->id 
		) ),
		'htmlOptions' => array (
...
<div class="box-body">
<?php echo $form->dropDownListRow($model, 'mrn_id',$model->getMrnOptions($user->id),array('class'=>'form-control')); ?>

<?php

echo $form->datepickerRow ( $model, 'mrs_req_date', array (
...
$('#MrnDetail_mrn_id').change(function(){
	...
	var url = '<?php echo Yii::app()->createUrl('mrnDetail/index')?>/id/'+vendor_id+'/mrnid/'+mrsid;
