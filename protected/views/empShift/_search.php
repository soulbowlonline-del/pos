...
?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'emp_id', GxHtml::listDataEx(Emp::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'shift_id'); ?>
		<?php echo $form->dropDownList($model, 'shift_id', GxHtml::listDataEx(Shift::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
