...
<?php    $this->widget('bootstrap.widgets.TbMenu', array(
       ...
       'items' => array(
        		array('label' => 'Export',
        				'url' => array('city/admin' ,'exportCSV'=>'1',
	...
	'columns' => array(
		...
		*/
			array(
					...
					'buttons'=>array(
							'view'=>array(
									'visible'=>'$data->checkPermission ("city/view")=="true"',
									'url' =>'Yii::app()->controller->createUrl("city/view", array("id" => $data->id))',
									'label'=>'View',
									'options'=>array('class'=>'view'),
			
							),
							'update'=>array(
									'visible'=>'$data->checkPermission ("city/update")=="true"',
									'url' =>'Yii::app()->controller->createUrl("city/update", array("id" => $data->id))',
									'label'=>'Update',
