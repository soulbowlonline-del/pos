...
<?php echo $form->textFieldRow($model,'short_name',array('class'=>'form-control','maxlength'=>20)); ?>
<?php  if( $model->item_code == '')
	$model->item_code = User::randomBarcode('5');?>	
<?php echo $form->hiddenField($model,'item_code',array('class'=>'form-control','maxlength'=>255)); ?>
   ...
   $this->widget('ext.typeahead.TbTypeAhead',array(
              ...
              'options' => array(
                           array(
                                         ...
                                         'valueKey' => 'name',
                                         'remote' => array(
                                                       'url' => Yii::app()->createUrl('/item/hsnCodeList') . '?term=%QUERY',
                                         ),
                           		'template' => '<p>{{name}}</p>',
...
<?php echo $form->dropDownListRow($model, 'category_id', $model->getParentCategorys(),array('class'=>'form-control')); ?>
<div class="form-group">
...
<?php echo $form->dropDownListRow($model,'item_type',$model->getTypeOptions(),array('class'=>'form-control')); ?>
							...
							<div class="col-md-6">
								<h2>Sale Info</h2>
<?php echo $form->checkBoxRow($model, 'is_discount',array('checked'=>'checked')); ?>
...
<?php echo CHtml::activeListBox($model, 'vendor_id', Item::getAllVendors(), array('class'=>'chosen', 'multiple'=>true, 'data-placeholder'=>'Select'))?>
