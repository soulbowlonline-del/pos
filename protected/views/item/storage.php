...
<section class="content"> 
  ...
  <div class="row">
    <div class="col-lg-2 col-xs-6 pd-7 col-sm-5ths"> 
      <!-- small box -->
      <a href="<?php echo Yii::app()->createUrl('site/performance')?>" class="small-box-footer">
    ...
    <div class="col-lg-2 col-xs-6 pd-7 col-sm-5ths"> 
      <!-- small box -->
      <a href="<?php echo Yii::app()->createUrl('site/storage')?>" class="small-box-footer">
    ...
    <div class="col-lg-2 col-xs-6 pd-7 col-sm-5ths"> 
      <!-- small box -->
       <a href="<?php echo Yii::app()->createUrl('site/quality')?>" class="small-box-footer">
    ...
    <div class="col-lg-2 col-xs-6 pd-7 col-sm-5ths"> 
      <!-- small box -->
      <a href="<?php echo Yii::app()->createUrl('site/physicalVerification')?>" class="small-box-footer">
  ...
  <div class="col-lg-2 col-xs-6 pd-7 col-sm-5ths"> 
      <!-- small box -->
        <a href="<?php echo Yii::app()->createUrl('site/recovery')?>" class="small-box-footer">
