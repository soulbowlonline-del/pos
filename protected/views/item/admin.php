...
<?php    $this->widget('bootstrap.widgets.TbMenu', array(
       ...
       'items' => array(
        		array('label' => 'Export',
					...
					array('label' => 'Export Margin',
        				'url' => array('item/export' ,'exportCSV'=>'1',
        						
        		
        		),
					),
					array('label' => 'Export New MRP',
        				'url' => array('item/exportnew' ,'exportCSV'=>'1',
        						
        		
        		),
					),
					array('label' => 'Import Tax Data',
        				'url' => array('item/importTaxData'),
					),
					array('label' => 'Batch Update Prices',
        				'url' => array('item/batchUpdatePrices'),
					),
       ),
   ));  ?>
	...
	'columns' => array(
		...
		//'item_code',
			...
			array('header'=>'Tax',
					...
					'editable' => array(
							'url'     => $this->createUrl('item/taxUpdate'),
							'placement'  => 'left',
							'inputclass' => 'span3',
							'attribute' =>'tax_id',
							'type'     => 'select',
			...
			array(
					...
					'headerHtmlOptions' => array('style' => 'width: 110px'),
					'editable' => array(
							'url'     => $this->createUrl('item/gridUpdate'),
							'placement'  => 'left',
							'inputclass' => 'span3',
	...
	/* 	array(
			...
			array(
					...
					'editable' => array(
							...
							'url' =>$this->createUrl('item/toggle'),
							'placement'  => 'left',
							'inputclass' => 'span3',
							'attribute' =>'status',
							'type'     => 'select',
		...
		*/
			array(
					...
					'editable' => array(
							...
							'attribute' =>'vendor_id',
							'type'     => 'select',
							'source' => GxHtml::listDataEx(Vendor::model()->findAllAttributes(null, true)),
							//  'apply' => '$data->getStateValue('.$model->id.') == "0"'
			...
			array(
					...
					'buttons'=>array(
							'Free'=>array(
									//'visible'=>'$data->checkPermission ("itemDetail/admin")=="true"',
									'url' =>'Yii::app()->controller->createUrl("freeItem/admin", array("id" => $data->id))',
									'label'=>'Free Items',
									'options'=>array('class'=>'view'),
