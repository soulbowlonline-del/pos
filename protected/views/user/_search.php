...
?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model, 'lat', array('maxlength' => 32)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'long'); ?>
		<?php echo $form->textField($model, 'long', array('maxlength' => 32)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'contact_no'); ?>
		<?php echo $form->textField($model, 'contact_no', array('maxlength' => 255)); ?>
	</div>
...
; ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model, 'address', array('size'=>80,'maxlength' => 512)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model, 'lang', array('maxlength' => 8)); ?>
	</div>
