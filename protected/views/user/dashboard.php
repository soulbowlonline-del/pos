  ...
  <div class="row">
    <div class="col-lg-3 col-xs-6"> 
      ...
      <div class="small-box ">
        ...
        <a href="<?php echo Yii::app()->createUrl('item/admin');?>" class="small-box-footer bg-aqua">More info <i class="fa fa-arrow-circle-right"></i></a> </div>
    </div>
    ...
    <div class="col-lg-3 col-xs-6"> 
      ...
      <div class="small-box">
        ...
        <a href="<?php echo Yii::app()->createUrl('vendor/admin');?>" class="small-box-footer bg-green">More info <i class="fa fa-arrow-circle-right"></i></a> </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-xs-6"> 
      <!-- small box -->
    ...
    <!-- ./col --> 
      ...
      <div class="row">
        ...
        <?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
			'id' => 'user-form',
		'type' => 'horizontal',
		'action'=> Yii::app()->createUrl('user/setSession'),
...
echo $form->dropDownListRow($model, 'session_id',
		GxHtml::listDataEx(Session::model()->findAllAttributes(null, true)),array('class' => 'form-control')); ?>
...
<?php echo $form->textFieldRow($model,'api_key',array('class'=>'form-control')); ?>
</div>
<div class="col-md-3">
<?php echo $form->textFieldRow($model,'ivr_username',array('class'=>'form-control')); ?>
</div>
<div class="col-md-3">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  $mrsapproved = Mrs::model()->countByAttributes(array('status'=>Mrs::STATUS_DONE));
                  ?>
                  ...
                  $mrnapproved = Mrn::model()->countByAttributes(array('status'=>Mrn::STATUS_APPROVED));
                  ?>
                  ...
                  $poapproved = PurchaseOrder::model()->countByAttributes(array('status'=>PurchaseOrder::STATUS_APPROVED));
                  ?>
   ...
   <div class="box box-primary">
            ...
            <?php if($notifications){?>
              ...
              if($type == Notification::TYPE_MRS){
              	...
              	$link = Yii::app()->createUrl('mrsDetail/admin');
              	}
              }
              if($type == Notification::TYPE_MRN){
              	if($user->checkPermission('mrnDetail/admin')){
              		$link = Yii::app()->createUrl('mrnDetail/admin');
              	}
              }
