<div class="view">
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('long')); ?>:
	<?php echo GxHtml::encode($data->long); ?>
	<br />
	<?php /*
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('is_passenger')); ?>:
	<?php echo GxHtml::encode($data->is_passenger); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('is_dispatcher')); ?>:
	<?php echo GxHtml::encode($data->is_dispatcher); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('is_driver')); ?>:
	<?php echo GxHtml::encode($data->is_driver); ?>
	<br />
