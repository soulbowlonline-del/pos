...
<section class="content-header">
	...
	<?php /*?><a href="<?php echo Yii::app()->createUrl('mrs/admin');?>" class="btn btn-info export-btn" target="_blank">Merge</a>
*/ ?>
</section>
			...
			<div class="box">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<?php $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
								...
								'action' => Yii::app()->createUrl('mrsDetail/admin', array('id' => $user->id)),
								...
								<div class="col-md-10 col-sm-12 col-xs-12 margin10">
									...
									<div class="row">
										...
										<div class="col-md-2 col-xs-12 padding2px">
											...
											<label class="control-label" for="">Bar Code</label>
											<?php echo $form->textField($model, 'bar_code', array('class' => 'form-control', 'id' => 'MrsDetail_bar_code')); ?>
										</div>
               ...
               */ ?>
										...
										<div class="col-md-1 col-xs-12 padding2px">
											...
											<?php echo $form->textField($model, 'price',  array('class' => 'form-control', 'id' => 'MrsDetail_price_field')); ?>
										</div>
			...
			array(
					...
					'value'=>'GxHtml::valueEx($data->mrs->vendor)',
											...
											array(
												...
												'value' => 'GxHtml::activeTextField($data,\'min_qty\', array("id"=>"min_input_qty$data->id","class"=>"min_input_qty","readOnly"=>true))',
												'type' => 'raw',
    				...
    				'filter'=>false,
											...
											array(
												...
												'value' => 'GxHtml::activeTextField($data,\'ai_qty\', array("id"=>"req_input_qty$data->id","class"=>"req_input_qty","readOnly"=>true))',
												'type' => 'raw',
												'htmlOptions' => array('class' => 'ai_qty'),
												'filter' => false
				...
				'value'=>'$data->req_qty',
				'filter'=>false,
				//	'filterHtmlOptions'=>array('style'=>'width: 20px'),
			), */
											array(
											...
											array(
												...
												'header' => 'Mrp',
												'value' => 'GxHtml::activeTextField($data,\'mrp\', array("id"=>"mrp_input$data->id","class"=>"mrp_input","readOnly"=>true))',
												'type' => 'raw',
											...
											array(
												...
												'header' => 'Sale Rate',
												'value' => 'GxHtml::activeTextField($data,\'sale_rate\', array("id"=>"sale_rate$data->id","class"=>"sale_rate_input","disabled"=>$data->getCompanyBarcode($data->item_detail_id),"readOnly"=>true))',
												'type' => 'raw',
											...
											array(
												...
												'header' => 'Adjust Type',
												'value' => 'GxHtml::dropDownList("MrsDetail[adjust_type_id]",$data->adjust_type_id,$data->getAdjustTypeOptions($data->adjust_type_id),array("id"=>"adjust_type$data->id","class"=>"adjust_type","readOnly"=>true))',
												'type' => 'raw',
												'htmlOptions' => array(
													'class' => 'adjust_type'
												)
											...
											array(
												...
												'value' => 'GxHtml::activeTextField($data,\'adjust_qty\', array("id"=>"adjust_qty$data->id","class"=>"adjust_qty","value"=>"0.000","readOnly"=>true))',
												'type' => 'raw',
												'htmlOptions' => array('class' => 'adjust_qty'),
												'filter' => false
											...
											array(
												...
												'header' => 'Price',
												'value' => 'GxHtml::activeTextField($data,\'price\', array("id"=>"price_input$data->id","class"=>"price_inpput","readOnly"=>true))',
												'type' => 'raw',
											...
											array(
												...
												'header' => 'Amt',
												'value' => 'GxHtml::activeTextField($data,\'amount\',array("id"=>"total_amount_input$data->id","class"=>"total_amount_input","readOnly"=>true))',
												'type' => 'raw',
											...
											array(
												...
												'header' => 'Dis%',
												'value' => 'GxHtml::activeTextField($data,\'discount\',array("id"=>"discount_input$data->id","class"=>"discount_input","readOnly"=>true))',
												'type' => 'raw',
											...
											array(
												...
												'header' => 'Disc Amt',
												'value' => 'GxHtml::activeTextField($data,\'discount_amt\',array("id"=>"discount_amt_input$data->id","class"=>"discount_amt_input","readOnly"=>true))',
												'type' => 'raw',
											...
											array(
												...
												'header' => 'Other Disc%',
												'value' => 'GxHtml::activeTextField($data,\'discount1\',array("id"=>"discount1_input$data->id","class"=>"discount1_input","readOnly"=>true))',
												'type' => 'raw',
											...
											array(
												...
												'value' => 'GxHtml::activeTextField($data,\'discount_amt1\',array("id"=>"discount_amt1_input$data->id","class"=>"discount_amt1_input","readOnly"=>true))',
												'type' => 'raw',
										...
										$(document).ready(function() {
											...
											$("#approve").click(function(event) {
												if (confirm("Do you really want to save?") == true) {
													...
													$.ajax({
														url: '<?php echo Yii::app()->createUrl('mrsDetail/ajaxupdate'); ?>/' + mrsid,
														type: 'post',
...
<?php $taxes = Tax::model()->findAllByAttributes(array('status'=>MrsDetail::STATUS_PENDING));?>
<?php if($taxes){?>
<table>
<tr>
<th>Title</th>
...
<script>
	...
	function checkMrsNo(vendor_id) {
		...
		jQuery.ajax({
			'type': 'POST',
			'url': '<?php echo CController::createUrl('mrsDetail/ajaxMrsNo') ?>',
			'data': {
				'vendor_id': vendor_id
			},
			'success': function(data) {
	...
	function checkBarcodes() {
		...
		jQuery.ajax({
			'type': 'POST',
			'url': '<?php echo CController::createUrl('mrsDetail/ajaxItems') ?>',
			'data': {
				'item_id': item_id
			},
			'success': function(data) {
	...
	function checkTaxes() {
		...
		jQuery.ajax({
			'type': 'POST',
			'url': '<?php echo CController::createUrl('mrsDetail/ajaxTax') ?>',
			'data': {
				'item_id': item_id,
...
<script>
	$('#MrsDetail_mrs_id').change(function() {
		...
		var mrsid = $('#MrsDetail_mrs_id').val();
		var url = '<?php echo Yii::app()->createUrl('mrsDetail/admin') ?>/id/' + vendor_id + '/mrsid/' + mrsid;
	...
	$('#yw3').click(function() {
		...
		if (req_qty != '') {
			...
			if (mrsid != '') {
				...
				jQuery.ajax({
					'type': 'POST',
					'url': '<?php echo CController::createUrl('mrsDetail/ajaxCreate') ?>/id/' + mrsid,
