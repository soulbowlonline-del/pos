...
<?php    $this->widget('bootstrap.widgets.TbMenu', array(
       ...
       'items' => array(
        		array('label' => 'Export',
        				'url' => array('question/admin' ,'exportCSV'=>'1',
	...
	'columns' => array(
		...
		array(
			...
			array(
					...
					'buttons'=>array(
							'view'=>array(
									'visible'=>'$data->checkPermission ("question/view")=="true"',
									'url' =>'Yii::app()->controller->createUrl("question/view", array("id" => $data->id))',
									'label'=>'View',
									'options'=>array('class'=>'view'),
			
							),
							'update'=>array(
									'visible'=>'$data->checkPermission ("question/update")=="true"',
