...
<?php    $this->widget('bootstrap.widgets.TbMenu', array(
       ...
       'items' => array(
        		array('label' => 'Export',
        				'url' => array('itemCategory/subcategory' ,'exportCSV'=>'1',
...
<?php $this->widget ( 'bootstrap.widgets.TbExtendedGridView', array (
	...
	'dataProvider' => $model->subcatsearch(),
	'pager' => true,
	'filter' => $model,
	'columns' => array(
			'id',
			...
			array(
					...
					'buttons'=>array(
							'view'=>array(
									...
									'url' =>'Yii::app()->controller->createUrl("itemCategory/subview", array("id" => $data->id))',
									'label'=>'View',
							...
							'update'=>array(
									...
									'url' =>'Yii::app()->controller->createUrl("itemCategory/subUpdate", array("id" => $data->id))',
									'label'=>'Update',
