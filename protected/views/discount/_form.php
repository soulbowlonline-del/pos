...
<?php echo $form->textFieldRow($model,'applicable_amt',array('class'=>'form-control')); ?>
<?php echo $form->dropDownListRow($model, 'discount_type',
			$model->getDiscountTypeOptions(),array('class'=>'form-control')); ?>
			<div id="items" style="display:none">
			<?php echo $form->dropDownListRow($model, 'item_detail_id',$model->getItemOptions(),array('multiple'=>'multiple')); ?></div>
