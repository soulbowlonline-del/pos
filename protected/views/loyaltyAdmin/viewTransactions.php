...
$displayName = ($customer && trim($customer->name) !== '') ? CHtml::encode($customer->name) : ($customer ? CHtml::encode($customer->contact_no) : 'Unknown');
...
$this->pageTitle = 'Transactions - ' . strip_tags($displayName);
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <?php echo CHtml::link(
                            '<i class="fa fa-pencil"></i> Adjust Points',
                            array('adjustPoints', 'customer_id' => $loyalty->customer_id),
                            ...
                            <div class="description-block">
                                <?php if ($customer && $customer->contact_no): ?>
                                    <span class="description-header" style="font-size:16px;">
                                        <i class="fa fa-phone text-muted"></i> <?php echo CHtml::encode($customer->contact_no); ?>
                                    </span>
                                <?php endif; ?>
                                <?php if ($customer && $customer->email): ?>
                                    <p class="description-text">
                                        <i class="fa fa-envelope text-muted"></i> <?php echo CHtml::encode($customer->email); ?>
                                    </p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <?php $this->widget('bootstrap.widgets.TbGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    ...
                                    'htmlOptions' => array('style' => 'width:100px; white-space:nowrap;'),
                                ),
                                ...
                                array(
                                    ...
                                    'value'       => function($data) {
                                        ...
                                        return '<span class="label label-' . $cls . '" style="font-size:11px;">'
                                            . CHtml::encode($data->transaction_type) . '</span>';
                                    },
                                ...
                                array(
                                    ...
                                    'value'       => function($data) {
                                        ...
                                        return CHtml::link(
                                            '#' . $data->order_id,
                                            array('/order/view', 'id' => $data->order_id),
                                ...
                                array(
                                    ...
                                    'type'        => 'raw',
                                    'value'       => function($data) {
                                        return '<small>' . CHtml::encode($data->description) . '</small>';
                                    },
                                ),
