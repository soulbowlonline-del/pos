<?php
$this->pageTitle = 'Loyalty Program Reports';
                                    ...
                                    <?php foreach ($recentTransactions as $trans): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                $displayName = $custName !== '' ? CHtml::encode($custName) : ($custPhone ? CHtml::encode($custPhone) : '<em class="text-muted">Unknown</em>');
                                                ?>
                                                <strong><?php echo $displayName; ?></strong>
                                                <?php if ($custName !== '' && $custPhone): ?>
                                                    <br><small class="text-muted"><?php echo CHtml::encode($custPhone); ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php
                                            ...
                                            <td>
                                                <small><?php echo CHtml::encode($trans->description); ?></small>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else: ?>
        ...
        <div class="col-md-4">
            <div class="box box-success">
                ...
                <div class="box-body no-padding">
                    ...
                    $criteria->order = 't.total_points DESC';
                    $criteria->limit = 10;
                    $criteria->condition = 'total_points > 0';
                    $topCustomers = CustomerLoyalty::model()->findAll($criteria);
                    ?>

                    <?php if (!empty($topCustomers)): ?>
                        <ul class="list-group list-group-unbordered" style="margin-bottom:0;">
                            <?php
                            $rankColors = array('#f39c12', '#95a5a6', '#cd7f32'); // gold, silver, bronze
                            foreach ($topCustomers as $index => $loyalty):
                                ...
                                $displayLabel = $cName !== '' ? CHtml::encode($cName) : ($cPhone ? CHtml::encode($cPhone) : 'Unknown');
                                $badgeStyle = $index < 3
                                ...
                                <li class="list-group-item" style="padding: 10px 15px;">
                                    <div style="display:flex; align-items:center; gap:10px;">
                                        ...
                                        <div style="flex:1; min-width:0;">
                                            ...
                                            <?php if ($cName !== '' && $cPhone): ?>
                                                <small class="text-muted"><?php echo CHtml::encode($cPhone); ?></small>
                                            <?php endif; ?>
                                        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <?php
                    $ranges = array(
                        '0–50'      => Yii::app()->db->createCommand()->select('COUNT(*)')->from('tbl_customer_loyalty')->where('total_points BETWEEN 0 AND 50')->queryScalar(),
                        '51–100'    => Yii::app()->db->createCommand()->select('COUNT(*)')->from('tbl_customer_loyalty')->where('total_points BETWEEN 51 AND 100')->queryScalar(),
                        '101–500'   => Yii::app()->db->createCommand()->select('COUNT(*)')->from('tbl_customer_loyalty')->where('total_points BETWEEN 101 AND 500')->queryScalar(),
                        '501–1000'  => Yii::app()->db->createCommand()->select('COUNT(*)')->from('tbl_customer_loyalty')->where('total_points BETWEEN 501 AND 1000')->queryScalar(),
                        '1000+'     => Yii::app()->db->createCommand()->select('COUNT(*)')->from('tbl_customer_loyalty')->where('total_points > 1000')->queryScalar(),
                    );
        ...
        <div class="col-md-6">
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <?php
                    $transactionTypes = array('EARN', 'REDEEM', 'BONUS', 'ADJUST', 'EXPIRE');
                    $transactionCounts = array();
                    foreach ($transactionTypes as $type) {
                        $transactionCounts[$type] = Yii::app()->db->createCommand()
                            ->select('COUNT(*)')
                            ->from('tbl_loyalty_transactions')
                            ->where('transaction_type = :type AND created_at >= DATE_SUB(NOW(), INTERVAL 30 DAY)', array(':type' => $type))
                            ->queryScalar();
                    }
        ...
        <div class="col-md-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo Yii::app()->createUrl('loyaltyAdmin/exportReport'); ?>" class="btn btn-success btn-sm">
