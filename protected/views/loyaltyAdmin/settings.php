<?php
$this->pageTitle = 'Loyalty Program Settings';
                    ...
                    <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <small class="help-block text-muted">
                                        <?php echo CHtml::encode($setting->description); ?>
                                    </small>
                                </div>
                            </div>
                        <?php endforeach; ?>
                        ...
                        <?php if (empty($settings)): ?>
                            <div class="alert alert-warning">
                                ...
                                No settings found. 
                                <a href="<?php echo $this->createUrl('initializeSettings'); ?>" class="btn btn-warning btn-sm">
                    ...
                    <?php if (!empty($settings)): ?>
                        <div class="box-footer">
                            <div class="col-sm-offset-4 col-sm-8">
                                ...
                                <a href="<?php echo $this->createUrl('initializeSettings'); ?>" class="btn btn-warning">
                        ...
                        <div class="col-md-2">
                            <div class="description-block border-right">
                                <span class="description-percentage text-purple">
                                    <?php 
                                    $avgPoints = Yii::app()->db->createCommand()
