...
<?php $this->widget('bootstrap.widgets.TbDetailView', array(
		...
		'name' => 'purchaseBill',
		'type' => 'raw',
		'value' => $model->purchaseBill !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->purchaseBill)), array('purchaseBill/view', 'id' => GxActiveRecord::extractPkValue($model->purchaseBill, true))) : null,
		),
		array(
		'name' => 'outlet',
		'type' => 'raw',
