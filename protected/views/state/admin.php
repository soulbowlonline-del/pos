...
<?php    $this->widget('bootstrap.widgets.TbMenu', array(
       ...
       'items' => array(
        		array('label' => 'Export',
        				'url' => array('state/admin' ,'exportCSV'=>'1',
	...
	'columns' => array(
		...
		*/
			array(
					...
					'buttons'=>array(
							'view'=>array(
									'visible'=>'$data->checkPermission ("state/view")=="true"',
									'url' =>'Yii::app()->controller->createUrl("state/view", array("id" => $data->id))',
									'label'=>'View',
									'options'=>array('class'=>'view'),
										
							),
							'update'=>array(
									'visible'=>'$data->checkPermission ("state/update")=="true"',
									'url' =>'Yii::app()->controller->createUrl("state/update", array("id" => $data->id))',
									'label'=>'Update',
