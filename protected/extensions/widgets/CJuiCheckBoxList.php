...
/**
 * CJuiCheckBoxList displays a radio button list widget.
 *
 ...
 * <pre>
 * $this->widget('ext.CJuiCheckBoxList', array(
 'model'=>$model,
 'attribute'=>'status',
 ...
 *
*/
class CJuiCheckBoxList extends CJuiInputWidget
{
	/**
	...
	*/
	...
	public function run()
	{
		...
		if ($this->hasModel())
		{
			...
			echo CHtml::checkBoxList($name, $select,$this->data,$this->htmlOptions );

			//echo CHtml::activeCheckBoxList($this->model, $select, $this->data ,$this->htmlOptions);
		}
		else
		{
