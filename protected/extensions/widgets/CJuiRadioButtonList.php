<?php
/**
 * CJuiRadioButtonList class file.
 *
...
/**
 * CJuiRadioButtonList displays a radio button list widget.
 *
 ...
 * <pre>
 * $this->widget('ext.CJuiRadioButtonList', array(
 'model'=>$model,
 'attribute'=>'status',
 ...
 *
*/
class CJuiRadioButtonList extends CJuiInputWidget
{
	/**
	...
	*/
	...
	public function run()
	{
		...
		if ($this->hasModel())
		{
			echo CHtml::activeRadioButtonList($this->model, $this->attribute, $this->data ,$this->htmlOptions);
		}
		else
		{
			echo CHtml::radioButtonList($name, $this->value,$this->data,$this->htmlOptions );
		}
		if ($this->buttonType=='buttonset')
		{
