...
class DefaultController extends Controller
{
	...
	public function getData($tableName)
	{
		...
		if($tableName != 'tbl_mrs' && $tableName != 'tbl_mrs_detail'&& $tableName != 'tbl_mrn' && $tableName != 'tbl_mrn_detail'
				&& $tableName != 'tbl_purchase_order' && $tableName != 'tbl_purchase_order_detail'&& $tableName != 'tbl_purchase_bill' && $tableName != 'tbl_purchase_bill_detail'&& $tableName != 'tbl_stock_log' && $tableName != 'tbl_stock_adjust_log'
				&& $tableName != 'tbl_notification'&& $tableName != 'tbl_order_refund'&& $tableName != 'tbl_order_refund_item'
				&& $tableName != 'tbl_advance_logs'&& $tableName != 'tbl_item_expire'&& $tableName != 'tbl_item_expire_item'
				&& $tableName != 'tbl_item_return'&& $tableName != 'tbl_item_return_item'&& $tableName != 'tbl_order'&& $tableName != 'tbl_order_item'){
			echo $tableName;
	...
	public function createZipBackup() {
		ini_set ( 'memory_limit', '-1' );
		
		ini_set ( 'max_execution_time', '0' );
	$z = new ZipArchive();
	$file_name =  $this->path . $this->back_temp_file . date('Y.m.d_H.i.s') . '.zip';
	$z->open($file_name, ZIPARCHIVE::CREATE);
	$z->addFile($this->file_name, basename ( $this->file_name ));
	$z->close();
	}
