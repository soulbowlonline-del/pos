  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php if($permission->checkPermission('user/dashboard')){?>
		...
		<?php }?> -->
		<?php if($permission->checkPermission('item/expireStock')){?>
          <li>
		...
		<?php }?>
		<?php if($permission->checkPermission('itemReturnItem/admin')){?>
         <li>
       ...
       <?php /*?>
        ...
        <?php }?>
          ...
          <?php }?>
             ...
             <?php if($permission->checkPermission('purchaseOrder/index')){?>
            <li>
          <a href="<?php echo Yii::app()->createUrl('purchaseOrder/index');?>">
              <i class="fa fa-list-alt"></i> <span>Purchase Order</span>
           
          </a>
        </li>
          <li>
          <a href="<?php echo Yii::app()->createUrl('bill/admin');?>">
          ...
          <?php }?>
          <?php }?>
         <?php if($permission->checkPermission('purchaseBillDetail/index') || $permission->checkPermission('purchaseOrder/index')){?>
           <li>
		...
		<li>
          <a href="<?php echo Yii::app()->createUrl('b2bpurchaseBillDetail/index');?>">
        ...
        <li>
          <a href="<?php echo Yii::app()->createUrl('advancePayment/admin');?>">
           ...
           <?php if($permission->checkPermission('order/userWise') || $permission->checkPermission('order/itemWise')||
          		$permission->checkPermission('order/deptWise')|| $permission->checkPermission('order/compWise')||
           		$permission->checkPermission('order/admin') || $permission->checkPermission('orderItem/admin') ||
           		$permission->checkPermission('tax/admin') || $permission->checkPermission('itemTax/admin') ||
           		$permission->checkPermission('order/groupTax') || $permission->checkPermission('order/b2bReport') || $permission->checkPermission('order/tax') ||
           		$permission->checkPermission('purchaseBillDetail/report') || $permission->checkPermission('purchaseBill/admin') ||
           		$permission->checkPermission('paymentReport/admin') ||$permission->checkPermission('orderRefundItem/admin') ||
           		$permission->checkPermission('stockAdjustLog/admin') || $permission->checkPermission('itemExpire/admin') ||
           		$permission->checkPermission('itemReturn/admin') || $permission->checkPermission('customer/admin')){?>
          ...
          <ul class="treeview-menu">
            ...
            <?php if($permission->checkPermission('order/userWise')){?>
             	<li>
          <a href="<?php echo Yii::app()->createUrl('b2bpurchaseBill/userWise');?>">
              <i class="fa fa-dot-circle-o"></i> <span>B2B UserWise Sale Report</span>
           
          </a>
        </li>
		 <?php }?>
		  <?php if($permission->checkPermission('order/itemWise')){?>
             <li>
          <a href="<?php echo Yii::app()->createUrl('order/b2bitemwise');?>">
        ...
        <?php }?>
		 <?php if($permission->checkPermission('order/admin')){?>
          <li>
          <a href="<?php echo Yii::app()->createUrl('order/b2borders');?>">
        ...
        <?php }?>
          ...
          <li>
          <a href="<?php echo Yii::app()->createUrl('orderItem/b2bdetail');?>">
              <i class="fa fa-dot-circle-o"></i> <span>B2b Order Details</span>
           
          </a>
        </li>
		  <li>
          <a href="<?php echo Yii::app()->createUrl('orderItem/b2bsales');?>">
		 ...
		 <?php if($permission->checkPermission('order/b2bReport')){?>
         <li>
          <!--<a href="<?php echo Yii::app()->createUrl('order/b2bReport');?>">-->
          <a href="<?php echo Yii::app()->createUrl('b2bpurchaseBillDetail/taxwise');?>">
        ...
        <?php }?>
        <?php if($permission->checkPermission('order/deptWise')){?>
        <li>
        ...
        <?php }?>
        <?php if($permission->checkPermission('order/compWise')){?>
        <li>
        ...
        <?php }?>
        <?php if($permission->checkPermission('order/vendorWise')){?>
        <li>
          <a href="<?php echo Yii::app()->createUrl('order/vendorWise');?>">
        ...
        <?php }?>
        <?php if($permission->checkPermission('itemTax/admin')){?>
         <li>
        ...
        <?php }?>
         <?php if($permission->checkPermission('order/groupTax')){?>
         <li>
		...
		<?php if($permission->checkPermission('order/groupTax')){?>
         <li>
          <a href="<?php echo Yii::app()->createUrl('order/grouphsntax');?>">
        ...
        <?php if($permission->checkPermission('order/tax')){?>
         <li>
        ...
        <?php }?>
           <?php if($permission->checkPermission('purchaseBill/admin')){?>
          <li>
        ...
        <?php }?>
		 <li>
          <a href="<?php echo Yii::app()->createUrl('itemReturnItem/report');?>">
              <i class="fa fa-dot-circle-o"></i> <span>Debit Return Report</span>
           
          </a>
        </li>
          <?php if($permission->checkPermission('paymentReport/admin')){?>
        <li>
        ...
        <?php }?>
         <?php if($permission->checkPermission('orderRefundItem/admin')){?>
          <li>
        ...
        <?php }?>
         <?php if($permission->checkPermission('stockAdjustLog/admin')){?>
          <li>
        ...
        <?php }?>
         <?php  if($permission->checkPermission('item/report')){?>
          <li>
          <a href="<?php echo Yii::app()->createUrl('item/report');?>">
              <i class="fa fa-dot-circle-o"></i> <span>Stock Report</span>
           
          </a>
        </li>
        <?php }?>
        <?php if($permission->checkPermission('itemExpire/admin')){?>
        <li>
        ...
        <?php }?>
         <?php if($permission->checkPermission('itemReturn/admin')){?>
        <li>
        ...
        <?php }?>
        <li>
          <a href="<?php echo Yii::app()->createUrl('item/scannedItems');?>">
              <i class="fa fa-dot-circle-o"></i> <span>Scanned Items</span>
           
          </a>
        </li>
        <li>
          <a href="<?php echo Yii::app()->createUrl('customer/whatsapplogs');?>">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <a href="<?php echo Yii::app()->createUrl('loyaltyAdmin/customers'); ?>">
                <i class="fa fa-dot-circle-o"></i> <span>Customers</span>
              </a>
            </li>
            <li>
              <a href="<?php echo Yii::app()->createUrl('loyaltyAdmin/reports'); ?>">
                <i class="fa fa-dot-circle-o"></i> <span>Reports</span>
              </a>
            </li>
            <li>
              <a href="<?php echo Yii::app()->createUrl('loyaltyAdmin/settings'); ?>">
...
$('a[title]').on('mouseenter', function () {
  ...
  var ajax_call = function() {
	...
	function checkcount(){
		$.ajax({
		       url: '<?php echo Yii::app()->createUrl('onlineOrder/countOrders'); ?>',
		       type: 'get',
