...
SUITES="difftest emp_difftest cust_difftest order_difftest tally_difftest item_difftest
        ...
        uploadbill_difftest grn_difftest discount_difftest online_difftest orderwrite_difftest item3_difftest refund_difftest barcode_difftest updstock_difftest adjust_difftest itemorder_difftest"
