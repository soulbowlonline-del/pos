...
class Bootstrap extends CApplicationComponent
{
	...
	{
	//	$this->registerThemeCss('bootstrap' . (!YII_DEBUG ? '.min' : '') . '.css');
	}
	...
	public function registerThemeCss($cssFile, $media = '')
	{
		Yii::app()->getClientScript()->registerCssFile( Yii::app()->theme->baseUrl.  "/css/{$cssFile}", $media);
	}
	/**
