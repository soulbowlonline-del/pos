...
class Setting extends ActiveRecord
{
    ...
    {
        $value = $this->hasAttribute('check_val') ? $this->check_val : null;
    ...
    public function rules()
    {
        return [
            ...
            [['check_val'], 'string', 'max' => 255],
            [['create_time', 'api_key', 'ivr_username'], 'safe'],
            [['type_id', 'status', 'create_time'], 'default', 'value' => null],
            [['id', 'check_val', 'type_id', 'status', 'create_time'], 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function search($params = [])
    {
        ...
        foreach ([['check_val', 'check_val'], ['create_time', 'create_time']] as [$col, $attr]) {
