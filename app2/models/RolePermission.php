...
class RolePermission extends ActiveRecord
{
    ...
    {
        return [
            [['role_id', 'permission_id', 'create_time', 'create_user_id'], 'required'],
            [['role_id', 'permission_id', 'status', 'type_id', 'create_user_id', 'updated_by'], 'integer'],
            [['status', 'type_id', 'updated_by'], 'default', 'value' => null],
            [['id', 'role_id', 'permission_id', 'status', 'type_id', 'create_time', 'create_user_id', 'updated_by'], 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function search($params = [])
    {
        ...
        foreach ([['id', 'id'], ['role_id', 'role_id'], ['permission_id', 'permission_id'], ['status', 'status'], ['type_id', 'type_id'], ['create_user_id', 'create_user_id'], ['updated_by', 'updated_by']] as [$col, $attr]) {
