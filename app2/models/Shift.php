...
/**
 * Ported from protected/models/Shift.php and its giix base class.
 */
class Shift extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['description', 'start_time', 'end_time'], 'safe'],
            [['description', 'start_time', 'end_time', 'status', 'type_id', 'updated_by'], 'default', 'value' => null],
            [['id', 'title', 'description', 'start_time', 'end_time', 'status', 'type_id', 'create_time', 'create_user_id', 'updated_by'], 'safe', 'on' => 'search'],
        ];
    }
    ...
    {
        return $this->hasMany(EmpShift::class, ['shift_id' => 'id']);
    }
