...
/**
 * Ported from protected/models/EmpShift.php and its giix base class.
 */
class EmpShift extends ActiveRecord
{
    ...
    {
        return [
            [['emp_id', 'shift_id', 'create_time', 'create_user_id'], 'required'],
            [['emp_id', 'shift_id', 'status', 'type_id', 'create_user_id', 'updated_by'], 'integer'],
            [['status', 'type_id', 'updated_by'], 'default', 'value' => null],
            [['id', 'emp_id', 'shift_id', 'status', 'type_id', 'create_time', 'create_user_id', 'updated_by'], 'safe', 'on' => 'search'],
        ];
    }
