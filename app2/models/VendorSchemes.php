...
/**
 * Ported from protected/models/VendorSchemes.php and its giix base class.
 */
class VendorSchemes extends ActiveRecord
{
    ...
    {
        return $n == 1 ? 'VendorSchemes' : 'VendorSchemes';
    }
    ...
    {
        $value = $this->hasAttribute('start_date') ? $this->start_date : null;
    ...
    {
        return [
            [['vendor_id', 'item_id', 'total_sale', 'create_user_id'], 'required'],
            [['vendor_id', 'total_sale', 'type_id', 'status', 'create_user_id', 'updated_by'], 'integer'],
            [['discount'], 'number'],
            [['start_date', 'end_date', 'create_time', 'update_time'], 'safe'],
            [['start_date', 'end_date', 'discount', 'type_id', 'status', 'create_time', 'update_time', 'updated_by'], 'default', 'value' => null],
            [['id', 'vendor_id', 'item_id', 'total_sale', 'start_date', 'end_date', 'discount', 'type_id', 'status', 'create_time', 'update_time', 'create_user_id', 'updated_by'], 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function search($params = [])
    {
        ...
        foreach ([['id', 'id'], ['vendor_id', 'vendor_id'], ['item_id', 'item_id'], ['total_sale', 'total_sale'], ['discount', 'discount'], ['type_id', 'type_id'], ['status', 'status'], ['create_user_id', 'create_user_id'], ['updated_by', 'updated_by']] as [$col, $attr]) {
            Criteria::compare($query, $col, $this->$attr);
        }
        foreach ([['start_date', 'start_date'], ['end_date', 'end_date'], ['create_time', 'create_time'], ['update_time', 'update_time']] as [$col, $attr]) {
