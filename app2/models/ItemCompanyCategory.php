...
/**
 * Ported from protected/models/ItemCompanyCategory.php and its giix base class.
 */
class ItemCompanyCategory extends ActiveRecord
{
    ...
    {
        return '{{%item_company_category}}';
    }

    /** Yii 1's label(): the model's name, singular or plural. */
    public static function label($n = 1)
    {
        return $n == 1 ? 'ItemCompanyCategory' : 'ItemCompanyCategories';
    }
    ...
    {
        return [
            [['title', 'company_id', 'create_user_id'], 'required'],
            [['type_id', 'status', 'company_id', 'create_user_id', 'updated_by'], 'integer'],
            [['title'], 'string', 'max' => 255],
            [['create_time', 'update_time'], 'safe'],
            [['type_id', 'status', 'create_time', 'update_time', 'updated_by'], 'default', 'value' => null],
            [['id', 'title', 'type_id', 'status', 'create_time', 'update_time', 'company_id', 'create_user_id', 'updated_by'], 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function search($params = [])
    {
        ...
        foreach ([['id', 'id'], ['type_id', 'type_id'], ['status', 'status'], ['company_id', 'company_id'], ['create_user_id', 'create_user_id'], ['updated_by', 'updated_by']] as [$col, $attr]) {
    ...
    {
        return $this->hasMany(Item::class, ['sub_company_id' => 'id']);
    }
