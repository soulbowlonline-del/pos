...
class ItemExpire extends ActiveRecord
{
    ...
    public function search($params = [])
    {
        ...
        foreach ([['vendor_id', 'vendor_id'], ['outlet_id', 'outlet_id'], ['status', 'status'], ['type_id', 'type_id'], ['t.create_user_id', 'create_user_id'], ['t.updated_by', 'updated_by']] as [$col, $attr]) {
            Criteria::compare($query, $col, $this->$attr);
        }
        foreach ([['total_amt', 'total_amt'], ['date(t.create_time)', 'create_time']] as [$col, $attr]) {
