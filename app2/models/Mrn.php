...
class Mrn extends ActiveRecord
{
    ...
    {
        return [
            [['code', 'mrs_date', 'mrs_req_date', 'outlet_id', 'mrs_id', 'organization_id'], 'required'],
            [['status', 'type_id', 'create_user_id', 'updated_by', 'outlet_id', 'mrs_id', 'organization_id'], 'integer'],
            [['code'], 'string', 'max' => 255],
            [['mrs_update_date', 'remarks', 'create_time', 'update_time', 'vendor_id'], 'safe'],
            [['mrs_update_date', 'status', 'type_id', 'remarks', 'create_time', 'update_time', 'updated_by'], 'default', 'value' => null],
            [['id', 'code', 'mrs_date', 'mrs_update_date', 'mrs_req_date', 'status', 'type_id', 'remarks', 'create_time', 'update_time', 'create_user_id', 'updated_by', 'outlet_id', 'mrs_id', 'organization_id'], 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function search($params = [])
    {
        ...
        foreach ([['id', 'id'], ['status', 'status'], ['type_id', 'type_id'], ['create_user_id', 'create_user_id'], ['updated_by', 'updated_by'], ['outlet_id', 'outlet_id'], ['mrs_id', 'mrs_id'], ['vendor_id', 'vendor_id'], ['organization_id', 'organization_id']] as [$col, $attr]) {
