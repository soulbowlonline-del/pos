...
class Permission extends ActiveRecord
{
    ...
    {
        return $n == 1 ? 'Permission' : 'Permissions';
    }
    ...
    {
        return [
            [['title', 'url', 'create_time', 'create_user_id'], 'required'],
            [['status', 'type_id', 'create_user_id', 'updated_by'], 'integer'],
            [['title', 'url'], 'string', 'max' => 255],
            [['status', 'type_id', 'updated_by'], 'default', 'value' => null],
            [['id', 'title', 'url', 'status', 'type_id', 'create_time', 'create_user_id', 'updated_by'], 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function search($params = [])
    {
        ...
        foreach ([['title', 'title'], ['url', 'url'], ['create_time', 'create_time']] as [$col, $attr]) {
