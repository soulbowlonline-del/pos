...
/**
 * Ported from protected/models/UserPassword.php and its giix base class.
 */
class UserPassword extends ActiveRecord
{
    ...
    {
        return $n == 1 ? 'UserPassword' : 'UserPasswords';
    }
    ...
    {
        $value = $this->hasAttribute('password') ? $this->password : null;
    ...
    {
        return [
            [['password', 'create_time', 'create_user_id'], 'required'],
            [['status', 'type_id', 'create_user_id', 'updated_by'], 'integer'],
            [['password'], 'string', 'max' => 512],
            [['status', 'type_id', 'updated_by'], 'default', 'value' => null],
            [['id', 'password', 'status', 'type_id', 'create_time', 'create_user_id', 'updated_by'], 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function search($params = [])
    {
        ...
        foreach ([['password', 'password'], ['create_time', 'create_time']] as [$col, $attr]) {
