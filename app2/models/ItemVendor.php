...
class ItemVendor extends ActiveRecord
{
    ...
    {
        return $n == 1 ? 'ItemVendor' : 'ItemVendors';
    }
    ...
    {
        return [
            [['item_detail_id', 'vendor_id', 'create_time', 'create_user_id'], 'required'],
            [['item_code', 'vendor_price'], 'required'],
            [['item_detail_id', 'vendor_id', 'status', 'type_id', 'create_user_id', 'updated_by'], 'integer'],
            [['vendor_price', 'item_code'], 'safe'],
            [['status', 'type_id', 'updated_by'], 'default', 'value' => null],
            [['id', 'item_detail_id', 'vendor_id', 'status', 'type_id', 'create_time', 'create_user_id', 'updated_by'], 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function search($params = [])
    {
        ...
        foreach ([['id', 'id'], ['item_detail_id', 'item_detail_id'], ['vendor_id', 'vendor_id'], ['status', 'status'], ['type_id', 'type_id'], ['create_user_id', 'create_user_id'], ['updated_by', 'updated_by']] as [$col, $attr]) {
    ...
    {
        return $this->hasOne(Item::class, ['id' => 'item_detail_id']);
    }
