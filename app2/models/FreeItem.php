...
/**
 * Ported from protected/models/FreeItem.php and its giix base class.
 */
class FreeItem extends ActiveRecord
{
    ...
    {
        return [
            [['title', 'item_id', 'item_detail_id', 'item_category_id', 'create_user_id'], 'required'],
            [['item_id', 'item_detail_id', 'item_category_id', 'item_company_id', 'qty', 'stock_qty', 'type_id', 'status', 'create_user_id', 'updated_by'], 'integer'],
            [['title'], 'string', 'max' => 255],
            [['create_time', 'update_time', 'name'], 'safe'],
            [['item_company_id', 'qty', 'stock_qty', 'type_id', 'status', 'create_time', 'update_time', 'updated_by'], 'default', 'value' => null],
            [['id', 'title', 'item_id', 'item_detail_id', 'item_category_id', 'item_company_id', 'qty', 'stock_qty', 'type_id', 'status', 'create_time', 'update_time', 'create_user_id', 'updated_by'], 'safe', 'on' => 'search'],
        ];
    }
    ...
    {
        return $this->hasOne(ItemCompany::class, ['id' => 'item_company_id']);
    }
