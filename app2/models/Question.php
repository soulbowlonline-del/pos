...
/**
 * Ported from protected/models/Question.php and its giix base class.
 */
class Question extends ActiveRecord
{
    ...
    {
        return [
            [['title', 'description', 'create_user_id'], 'required'],
            ...
            [['id', 'title', 'description', 'type_id', 'status', 'create_time', 'update_time', 'create_user_id', 'updated_by'], 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function search($params = [])
    {
        ...
        foreach ([['title', 'title'], ['description', 'description'], ['create_time', 'create_time'], ['update_time', 'update_time']] as [$col, $attr]) {
