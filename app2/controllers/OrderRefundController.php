...
/**
 * Yii 2 port of protected/controllers/OrderRefundController.php.
 *
 ...
 */
class OrderRefundController extends BaseUiController {
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new ActiveDataProvider(['query' => OrderRefund::find(),
            ...
            'sort' => ['defaultOrder' => OrderRefund::defaultOrder() ?: []],
	...
	{	
		...
		if ( $model == null ) $model = new OrderRefund();
		
		switch( $this->action->id)
		{
			case 'update':	
				{
					$this->menu[] = ['label'=>'View' , 'url' => Ui::to('orderRefund/view', ['id'=>$model->id]),'icon'=>'icon-plus icon-white'];
				}
			case 'create':
				{
					$this->menu[] = ['label'=>'Manage', 'url' => Ui::to('orderRefund/admin'),'icon'=>'icon-wrench icon-white'];							
					$this->menu[] = ['label'=>'List', 'url' => Ui::to('orderRefund/index'),'icon'=>'icon-th-list icon-white'];	
				}
				break;				
			case 'index':
				{
					$this->menu[] = ['label'=>'Manage', 'url' => Ui::to('orderRefund/admin'),'icon'=>'icon-wrench icon-white'];							
					$this->menu[] = ['label'=>'Create', 'url' => Ui::to('orderRefund/create'),'icon'=>'icon-plus icon-white'];
				}
				break;
			case 'admin':
				{
			...
			case 'view':
				{
					...
					$this->menu[] = ['label'=>'Create', 'url' => Ui::to('orderRefund/create'),'icon'=>'icon-plus icon-white'];
					$this->menu[] = ['label'=>'Update', 'url' => Ui::to('orderRefund/update', ['id' => $model->id]), 'icon'=>'icon-edit icon-white'];				
				}
				break;
		}
