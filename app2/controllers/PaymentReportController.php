...
/**
 * Yii 2 port of protected/controllers/PaymentReportController.php.
 *
 ...
 */
class PaymentReportController extends BaseUiController {
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new ActiveDataProvider(['query' => PaymentReport::find(),
            ...
            'sort' => ['defaultOrder' => PaymentReport::defaultOrder() ?: []],
	...
	{	
		...
		if ( $model == null ) $model = new PaymentReport();
		
		switch( $this->action->id)
		{
			case 'update':	
				{
					$this->menu[] = ['label'=>'View' , 'url' => Ui::to('paymentReport/view', ['id'=>$model->id]),'icon'=>'icon-plus icon-white'];
				}
			case 'create':
				{
					$this->menu[] = ['label'=>'Manage', 'url' => Ui::to('paymentReport/admin'),'icon'=>'icon-wrench icon-white'];							
					$this->menu[] = ['label'=>'List', 'url' => Ui::to('paymentReport/index'),'icon'=>'icon-th-list icon-white'];	
				}
				break;				
			case 'index':
				{
					$this->menu[] = ['label'=>'Manage', 'url' => Ui::to('paymentReport/admin'),'icon'=>'icon-wrench icon-white'];							
					$this->menu[] = ['label'=>'Create', 'url' => Ui::to('paymentReport/create'),'icon'=>'icon-plus icon-white'];
				}
				break;
			case 'admin':
				{
			...
			case 'view':
				{
					...
					$this->menu[] = ['label'=>'Create', 'url' => Ui::to('paymentReport/create'),'icon'=>'icon-plus icon-white'];
					$this->menu[] = ['label'=>'Update', 'url' => Ui::to('paymentReport/update', ['id' => $model->id]), 'icon'=>'icon-edit icon-white'];				
				}
				break;
		}
