...
/**
 * Yii 2 port of protected/controllers/CreditNoteController.php.
 *
 ...
 */
class CreditNoteController extends BaseUiController {
	...
	public function actionView($id) {
		...
		if (! ($model->checkPermission ( 'CreditNote/view' )))
			throw new ForbiddenHttpException(Yii::t ( 'app', 'You are not allowed to access this page.' ) );
	...
	public function actionCreate() {
		...
		if (! ($model->checkPermission ( 'CreditNote/create' )))
			throw new ForbiddenHttpException(Yii::t ( 'app', 'You are not allowed to access this page.' ) );
	...
	public function actionUpdate($id) {
		...
		if (! ($model->checkPermission ( 'CreditNote/update' )))
			throw new ForbiddenHttpException(Yii::t ( 'app', 'You are not allowed to access this page.' ) );
	...
	public function actionDelete($id) {
		...
		if (! ($model->checkPermission ( 'CreditNote/delete' )))
			throw new ForbiddenHttpException(Yii::t ( 'app', 'You are not allowed to access this page.' ) );
	...
	public function actionIndex() {
		...
		$dataProvider = new ActiveDataProvider(['query' => CreditNote::find(),
            ...
            'sort' => ['defaultOrder' => CreditNote::defaultOrder() ?: []],
	...
	public function actionAdmin() {
		$model = new CreditNote(['scenario' => 'search']);
		if (! ($model->checkPermission ( 'CreditNote/admin' )))
			throw new ForbiddenHttpException(Yii::t ( 'app', 'You are not allowed to access this page.' ) );
		$this->updateMenuItems ( $model );
			...
			case 'update' :
				{
					$this->menu [] = [
							...
							'url' => Ui::to('creditNote/view', ['id' => $model->id]),
							'visible'=> $model->checkPermission ("creditNote/view")=="true",
			...
			case 'create' :
				{
					$this->menu [] = [
							...
							'visible'=> $model->checkPermission ("creditNote/create")=="true",
			...
			case 'admin' :
				{
					...
					$this->menu [] = [
							...
							'visible'=> $model->checkPermission ("creditNote/admin")=="true",
							'icon' => 'icon-plus icon-white' 
					];
				}
				break;
			...
			case 'view' :
				{
					...
					$this->menu [] = [
							...
							'url' => Ui::to('creditNote/update', ['id' => $model->id]),
							'visible'=> $model->checkPermission ("creditNote/update")=="true",
