...
class ItemDetailController extends BaseUiController {
	...
	public function actionAdd() {
		...
		if (Yii::$app->request->post('ItemDetail') !== null) {
				...
				if ($model->save ()) {
					...
					if($itemstock == null){
						...
						if($_POST ['ItemDetail']['item_id']){
							$item = $this->loadModel($_POST ['ItemDetail']['item_id']);
						}
	...
	public function actionUpdate($id) {
		$model = $this->loadModel($id);
		$item = $this->loadModel($model->item_id);
	...
	public function actionSearch() {
		...
		if (Yii::$app->request->get('ItemDetail') !== null) {
