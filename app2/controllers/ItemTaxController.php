...
/**
 * Yii 2 port of protected/controllers/ItemTaxController.php.
 *
 ...
 */
class ItemTaxController extends BaseUiController {
	...
	public function actionCreate() {
		...
		$this->performAjaxValidation( $model, 'item-tax-form' );
		
		if (isset ( $_POST ['ItemTax'] )) {
			$model->load($_POST, 'ItemTax');
	...
	public function actionIndex() {
		...
		$dataProvider = new ActiveDataProvider(['query' => ItemTax::find(),
            ...
            'sort' => ['defaultOrder' => ItemTax::defaultOrder() ?: []],
	...
	public function actionSearch() {
		$model = new ItemTax(['scenario' => 'search']);
		$this->updateMenuItems ( $model );
		
		if (isset ( $_GET ['ItemTax'] )) {
			$model->load($_GET, 'ItemTax');
	...
	public function actionAdmin() {
		...
		$this->updateMenuItems ( $model );
		$columns = [];
		if (isset ( $_POST ['ItemTax'] ['columns'] )) {
			$columns = $_POST ['ItemTax'] ['columns'];
		}
		if (isset ( $_GET ['ItemTax'] ))
			$model->load($_GET, 'ItemTax');
			...
			case 'update' :
				{
					$this->menu [] = [
							...
							'url' => Ui::to('itemTax/view', ['id' => $model->id]),
			...
			case 'view' :
				{
					...
					$this->menu [] = [
							...
							'url' => Ui::to('itemTax/update', ['id' => $model->id]),
