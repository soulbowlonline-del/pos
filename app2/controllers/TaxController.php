...
/**
 * Yii 2 port of protected/controllers/TaxController.php.
 *
 ...
 */
class TaxController extends BaseUiController {
	...
	public function actionIndex() {
		...
		$dataProvider = new ActiveDataProvider(['query' => Tax::find(),
            ...
            'sort' => ['defaultOrder' => Tax::defaultOrder() ?: []],
			...
			case 'update' :
				{
					$this->menu [] = [
							...
							'url' => Ui::to('tax/view', ['id' => $model->id]),
			...
			case 'view' :
				{
					...
					$this->menu [] = [
							...
							'url' => Ui::to('tax/update', ['visible' => $model->checkPermission ( "tax/update" ) == "true",
									'id' => $model->id]),
