<?php
/**
 * Ported from protected/views/itemExpireItem/_view.php.
 */
...
<div class="view">
	...
	<br />
	<?php echo Html::encode($data->getAttributeLabel('item_expire_id')); ?>:
		<?php echo Html::encode(Gx::str($data->itemExpire)); ?>
	<br />
