     ...
     //   'purchase_bill_id',
		...
		'id',
    		...
    		[
    				'header'=>'Vendor',
    				'attribute' =>'vendor_id',
    				'value' => function ($data, $key, $index) { return Gx::str($data->itemReturn->vendor); },
    		...
    		[
    				'header'=>'Basic Value',
    			//	'attribute' =>'gross_amt',
    				'value' => function ($data, $key, $index) { return isset ( $data->itemReturn ) ? $data->itemReturn->gross_amt: ""; },
    		...
    		[
    				'header'=>'GRN NUMBER',
    				//'attribute' =>'purchase_bill_id',
    				'value' => function ($data, $key, $index) { return isset ( $data->itemReturn ) ? $data->itemReturn->grn_no: ""; },
