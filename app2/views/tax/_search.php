<?php
/**
 * Ported from protected/views/tax/_search.php.
 */
...
?>
	...
	<div class="row">
		<?php echo $form->label($model, 'tax_val1'); ?>
		<?php echo $form->textField($model, 'tax_val1'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'tax_val2'); ?>
		<?php echo $form->textField($model, 'tax_val2'); ?>
	</div>
