<?php
/**
 * Ported from protected/views/tax/_view.php.
 */
...
<div class="view">
	...
	<br />
	<?php echo Html::encode($data->getAttributeLabel('tax_val1')); ?>:
	<?php echo Html::encode($data->tax_val1); ?>
	<br />
	<?php echo Html::encode($data->getAttributeLabel('tax_val2')); ?>:
	<?php echo Html::encode($data->tax_val2); ?>
	<br />
