<?php
/**
 * Ported from protected/views/empShift/_search.php.
 */
...
?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'emp_id', Gx::listData(Emp::class), ['prompt' => 'All']); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'shift_id'); ?>
		<?php echo $form->dropDownList($model, 'shift_id', Gx::listData(Shift::class), ['prompt' => 'All']); ?>
	</div>
