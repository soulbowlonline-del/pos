<?php
/**
 * Ported from protected/views/empShift/view.php.
 */
...
[
			'attribute' => 'emp',
			'format' => 'raw',
			'value' => $model->emp !== null ? Html::a(Html::encode(Gx::str($model->emp)), Gx::url(['emp/view', 'id' => Gx::pk($model->emp)])) : null,
			],
[
			'attribute' => 'shift',
			'format' => 'raw',
			'value' => $model->shift !== null ? Html::a(Html::encode(Gx::str($model->shift)), Gx::url(['shift/view', 'id' => Gx::pk($model->shift)])) : null,
			],
[
				'attribute' => 'status',
				'format' => 'raw',
