<?php
/**
 * Ported from protected/views/empShift/_view.php.
 */
...
<div class="view">
	...
	<br />
	<?php echo Html::encode($data->getAttributeLabel('emp_id')); ?>:
		<?php echo Html::encode(Gx::str($data->emp)); ?>
	<br />
	<?php echo Html::encode($data->getAttributeLabel('shift_id')); ?>:
		<?php echo Html::encode(Gx::str($data->shift)); ?>
	<br />
