...
<?php    echo Menu::widget([
       ...
       'items' => [
        		['label' => 'Export',
        				'url' => ['itemCategory/subcategory' ,'exportCSV'=>'1',
	...
	'columns' => [
		...
		*/
			[
					...
					'buttons'=>[
							'view'=>[
									'visible' => function ($data) { return Access::check("itemCategory/view")=="true"; },
							...
							'update'=>[
									'visible' => function ($data) { return Access::check("itemCategory/update")=="true"; },
