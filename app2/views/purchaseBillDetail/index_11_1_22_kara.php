...
echo GridView::widget([
		...
		/* 	array(
			...
			array(
				...
				[
						'header' => 'Tax',
						'value' => function ($data, $key, $index) { return Html::dropDownList("PurchaseBillDetail[tax_id]",$data->tax_id,$data->getAllTaxOptions($data->tax_id),["id"=>"select_tax$data->id","class"=>"select_tax"]); },
						'format' => 'raw',
						'htmlOptions' => [
