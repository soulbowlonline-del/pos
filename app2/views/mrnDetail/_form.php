<?php
/**
 * Ported from protected/views/mrnDetail/_form.php.
 */
...
<?php echo $form->dropDownListRow($model, 'mrn_id', $model->getMrnOptions($id),['class'=>'form-control']); ?>
...
function checkBarcodes(){
	 var item_id = $('#MrnDetail_item_id').val();
	    jQuery.ajax({
	       'type': 'POST',
	       'url': '<?php echo Ui::to('item/ajaxUpdate') ?>',
