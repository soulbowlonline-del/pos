...
<?php echo $form->dropDownListRow($model, 'organization_id', Gx::listData(Organization::find()->where(['status'=>Organization::STATUS_ACTIVE])->orderBy(['id' => SORT_DESC])->all()),['class'=>'form-control']); ?>
