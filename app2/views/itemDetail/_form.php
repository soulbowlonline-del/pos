...
<div class="col-md-9">
<?php echo CHtml::activeListBox($model, 'outlet_id', Item::getAllOutlets(), ['class'=>'chosen', 'multiple'=>true, 'data-placeholder'=>'Select']) ?>
</div>
</div>
...
<?php echo $form->dropDownListRow($model, 'tax_id', Gx::listData(Tax::findAll(['status'=>Tax::STATUS_ACTIVE])),['class'=>'form-control']); ?>
