<?php
/**
 * Ported from protected/views/onlineOrder/_pdf.php.
 */
        ...
        <td width="49%" style="border:1px solid #EAEAEA !important; vertical-align:top;">
          ...
          <table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-bottom:0; margin-top:0;">
            ...
            <tbody>
                ...
                <?php if($order->comment != null && $order->comment != '' ){?>
                <tr>
                	<td style="padding:5px;">
                      <p style="margin:0; padding:0;"><b>Comment:</b> <?php echo $order->comment;?></p>
                    </td>
                </tr>
                <?php }?>
                <tr>
                	<td style="padding:5px;">
                      <p style="margin:0; padding:0;"><b>Order_from:</b> <?php echo $order->order_from;?></p>
                    </td>
                </tr>
            </tbody>
          </table>
