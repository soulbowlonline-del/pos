<?php
/**
 * Ported from protected/views/itemCompany/subview.php.
 */
...
<?php  $this->context->AddPanel($model->getRelationLabel('companycats'), $model->getRelatedDataProvider('companycats'),	'companycats','itemCompanyCategory');?>
