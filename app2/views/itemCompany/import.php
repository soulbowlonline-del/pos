<?php
/**
 * Ported from protected/views/itemCompany/import.php.
 */
...
<h1><?php echo 'Import' . ' ' . Html::encode($model->label()); ?>
  <a href="<?php echo '/themes/bar';?>/img/itemCompany.csv" class="btn btn-info">Sample</a></h1>
