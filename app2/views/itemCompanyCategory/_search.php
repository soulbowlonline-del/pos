<?php
/**
 * Ported from protected/views/itemCompanyCategory/_search.php.
 */
...
; ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'company_id', Gx::listData(Company::class), ['prompt' => 'All']); ?>
	</div>
