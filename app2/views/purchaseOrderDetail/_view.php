<?php
/**
 * Ported from protected/views/purchaseOrderDetail/_view.php.
 */
...
<div class="view">
	...
	<br />
	<?php echo Html::encode($data->getAttributeLabel('purchase_order_id')); ?>:
		<?php echo Html::encode(Gx::str($data->purchaseOrder)); ?>
	<br />
