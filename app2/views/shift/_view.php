<?php
/**
 * Ported from protected/views/shift/_view.php.
 */
...
<div class="view">
	...
	<br />
	<?php echo Html::encode($data->getAttributeLabel('start_time')); ?>:
	<?php echo Html::encode($data->start_time); ?>
	<br />
	<?php echo Html::encode($data->getAttributeLabel('end_time')); ?>:
	<?php echo Html::encode($data->end_time); ?>
	<br />
