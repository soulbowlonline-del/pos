...
<?php    echo Menu::widget([
       ...
       'items' => [
        		['label' => 'Export',
        				'url' => ['discount/admin' ,'exportCSV'=>'1',
	...
	'columns' => [
		...
		'title',
			[
					...
					'value' => function ($data, $key, $index) { return $data->getDiscountTypeOptions($data->discount_type); },
		...
		*/
			[
					...
					'buttons'=>[
							'view'=>[
									'visible' => function ($data) { return Access::check("discount/view")=="true"; },
							...
							'update'=>[
									'visible' => function ($data) { return Access::check("discount/update")=="true"; },
