<?php
/**
 * Ported from protected/views/purchaseOrder/_pdf.php.
 */
      ...
      <tbody>
      	<tr>
            <td colspan="4" align="center">
            	<h4 style="margin:0; padding:0; font-size:20px;">Purchase Order</h4> <br>
...
$vendor = Vendor::findOne( $po->vendor_id );
	$outlet = Outlet::findOne( $po->outlet_id );
     ...
     <td colspan="4" align="right">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>:</td>
                      <td><strong><?php echo $po->bill_amount;?></strong></td>
                    </tr>
                  </tbody>
    			</table>
          </td>
         ...
         <tr>
          <td colspan="2">
                  ...
                  <tbody>
                    ...
                    <tr><td style="padding:0; padding-top:5px;"><strong>Signature of Buyer</strong></td></tr>
                  </tbody>
    			</table>
          </td>
