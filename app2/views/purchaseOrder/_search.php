<?php
/**
 * Ported from protected/views/purchaseOrder/_search.php.
 */
...
; ?>
	...
	<div class="row">
		<?php echo $form->label($model, 'mrn_id'); ?>
		<?php echo $form->dropDownList($model, 'mrn_id', Gx::listData(Mrn::class), ['prompt' => 'All']); ?>
	</div>
