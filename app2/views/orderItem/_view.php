<?php
/**
 * Ported from protected/views/orderItem/_view.php.
 */
...
<div class="view">
	...
	<?php echo Html::encode($data->discount_id); ?>
	<br />
	<?php /*
	...
	<br />
	<?php echo Html::encode($data->getAttributeLabel('tax_amount')); ?>:
	<?php echo Html::encode($data->tax_amount); ?>
	<br />
