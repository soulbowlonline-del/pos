<?php
/**
 * Ported from protected/views/order/deptwise.php.
 */
...
<section class="content-header">
	...
	<h1><?php echo 'DepartmentWise Report'; ?></h1>
</section>
	...
	<div class="modal-dialog">
     ...
     <?php
					...
					$form = ActiveForm::begin([
							...
							'type' => 'horizontal',
							'action' => Ui::to( 'order/deptWiseExport?exportCSV=1' ),
...
$model->search();
if(isset(Yii::$app->session ['category_total'])){
	$cat_total = Yii::$app->session ['category_total'];
...
<?php echo GridView::widget([
	...
	'columns' => [
		...
		'title',
			[
					'header' => 'Total Amount',
					'value' => function ($data, $key, $index) { return $data->getCategoryTotalAmount(); },
					'footer'=>$cat_total
			],
		/* 	array(
					'header' => 'Parent',
