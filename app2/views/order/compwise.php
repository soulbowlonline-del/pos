<?php
/**
 * Ported from protected/views/order/compwise.php.
 */
...
<section class="content-header">
	...
	<h1><?php echo 'CompanyWise Report'; ?></h1>
</section>
	...
	<div class="modal-dialog">
     ...
     <?php
					...
					$form = ActiveForm::begin([
							...
							'type' => 'horizontal',
							'action' => Ui::to( 'order/compWiseExport?exportCSV=1' ),
...
<?php echo GridView::widget([
	...
	'columns' => [
		...
		'title',
			[
					'header' => 'Total Amount',
					'value' => function ($data, $key, $index) { return $data->getCompanyTotalAmount(); },
					'footer'=>$cat_total
			],
		/* 	array(
					'header' => 'Parent',
