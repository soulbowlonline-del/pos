<?php
/**
 * Ported from protected/views/order/userwise_15_7_21.php.
 */
	...
	<div class="modal-dialog">
     ...
     <?php
					...
					$form = ActiveForm::begin([
							...
							'type' => 'horizontal',
							'action' => Ui::to( 'order/userWiseExport?exportCSV=1' ),
	...
	'columns' => [
		//'id',
			...
			[
					...
					'value' => function ($data, $key, $index) { return $data->getTotalGrossAmount(); },
				//	'footer'=>$gross_total
					//'filter'=>Order::getStatusOptions(),
			],
			...
			[
					...
					'value' => function ($data, $key, $index) { return $data->getTotalGrossAmountData(); },
				
			],
			
			[
					'header' => '<a>Net Amount</a>',
					'value' => function ($data, $key, $index) { return $data->getTotalNetAmountData(); },
