<?php
/**
 * Ported from protected/views/order/admin.php.
 */
	...
	<div class="modal-dialog">
     ...
     <?php
					...
					$form = ActiveForm::begin([
							...
							'type' => 'horizontal',
							'action' => Ui::to( 'order/admin?exportCSV=1' ),
...
if($modes){
 ...
 echo $form->dropDownListRow($model,'mode_of_payment',$modes_array,['empty'=>'select']); ?>
</div>
	...
	'columns' => [
		...
		'bill_date',
			...
			[
					...
					'attribute' =>'total_amt',
					'value' => function ($data, $key, $index) { return $data->getOrderTotalAmount(); },
			
			],[
					'header' => '<a>Total Discount</a>',
					'attribute' =>'total_amt',
					'value' => function ($data, $key, $index) { return $data->getOrderTotaldiscountAmount(); },
			...
			[
					...
					'value' => function ($data, $key, $index) { return $data->getOrderTaxAmount(); },
