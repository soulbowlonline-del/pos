<?php
/**
 * Ported from protected/views/mail/recover_password.php.
 *
								...
								align="center" bgcolor="#FFFFFF" border="0" cellpadding="0"
										cellspacing="0"
												...
												<td align="left"
														...
														Dear <?php echo $user->full_name;?>,</p>
														<p
															style="font-size: 14px; color: #333333; line-height: 32px; ">
															In order to login, please use following credentials :</p>
      
<p>Email ID: <?php echo $user->email;?></p>


<?php 	$password = User::randomPassword();
