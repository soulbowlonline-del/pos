<?php
/**
 * Ported from protected/views/mail/mrn_added.php.
 *
								...
								align="center" bgcolor="#FFFFFF" border="0" cellpadding="0"
										cellspacing="0"
												...
												<td align="left"
														...
														<?php $vendor = Vendor::findOne(['id'=>$mrnmodel->vendor_id]);
														if($vendor){
															$user = User::findOne(['id'=>$mrnmodel->create_user_id]);
														}
														?>
														<p
														...
														$link = Url::to(Ui::to('mrnDetail/admin'), true);
														?>,</p>
														<p
