<?php
/**
 * Ported from protected/views/mail/customer_email.php.
 *
...
<table align="center" bgcolor="#F8F8F8" border="0" cellpadding="0"
		...
		align="center" bgcolor="#FFFFFF" border="0" cellpadding="0"
				cellspacing="0" class="responsive-table"
						...
						<tr>
						<td class="full"
								style="border: 1px solid #e8e8e8; font-family: Calibri Regular; color: #000000;"><table
								align="center" bgcolor="#FFFFFF" border="0" cellpadding="0"
										cellspacing="0"
												...
												<tr>
												<td align="left"
														style="padding: 5px; margin: 5px; display: block; font-family: Calibri Regular; font-size: 14px; line-height: 24px;">
														     <center><img alt="Image" class="logo" src="http://61.2.241.71/autoservice/email-logo.png"></center>
...
<?php /*if($image == true){?>
                          ...
                          <?php }*/?>
														...
														<p
															...
															Thanks & Regards, </p>
															<p
															style="font-size: 14px; color: #333333; line-height: 32px; ">SoulBowl.in</p>
													</td>
												</tr>
												<tr>
													<td align="center"
														style="padding: 10px 0; margin: 5px 0 0; display: block; background-color: #080024; font-family: Calibri Regular; font-size: 14px; color: #fff; line-height: 24px;"><div
															id="Footer" class="mktEditable"
															style="color: #fff; font-size: 13px; line-height: 22px;">Copyright &copy; <?php echo date('Y')?> Soulbowl.in. All rights reserved. </div></td>
												</tr>
