<?php
/**
 * Ported from protected/views/user/question.php.
 */
...
echo $form->dropDownListRow($model, 'question_id[]',
			$model->getQuestionOptions(),['class' => 'form-control','id'=>'UserQuestion_question_id'.$i]); ?>
 </div>
...
function checkQuestion(){
	...
	if($('#UserQuestion_answer1').val() == ''){
	 jQuery.ajax({
	       'type': 'POST',
	       'url': '<?php echo Ui::to('user/ajaxquestion') ?>',
