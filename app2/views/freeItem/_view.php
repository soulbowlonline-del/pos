<?php
/**
 * Ported from protected/views/freeItem/_view.php.
 */
...
<div class="view">
	...
	<br />
	<?php echo Html::encode($data->getAttributeLabel('item_category_id')); ?>:
		<?php echo Html::encode(Gx::str($data->itemCategory)); ?>
	<br />
	<?php echo Html::encode($data->getAttributeLabel('item_company_id')); ?>:
		<?php echo Html::encode(Gx::str($data->itemCompany)); ?>
	<br />
	<?php /*
	<?php echo Html::encode($data->getAttributeLabel('qty')); ?>:
	<?php echo Html::encode($data->qty); ?>
	<br />
	<?php echo Html::encode($data->getAttributeLabel('stock_qty')); ?>:
	<?php echo Html::encode($data->stock_qty); ?>
	<br />
