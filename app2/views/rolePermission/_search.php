<?php
/**
 * Ported from protected/views/rolePermission/_search.php.
 */
...
?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'role_id', Gx::listData(UserRole::class), ['prompt' => 'All']); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'permission_id'); ?>
		<?php echo $form->dropDownList($model, 'permission_id', Gx::listData(Permission::class), ['prompt' => 'All']); ?>
	</div>
