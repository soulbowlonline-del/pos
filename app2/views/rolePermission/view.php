<?php
/**
 * Ported from protected/views/rolePermission/view.php.
 */
...
[
			'attribute' => 'role',
			'format' => 'raw',
			'value' => $model->role !== null ? Html::a(Html::encode(Gx::str($model->role)), Gx::url(['userRole/view', 'id' => Gx::pk($model->role)])) : null,
			],
[
			'attribute' => 'permission',
			'format' => 'raw',
			'value' => $model->permission !== null ? Html::a(Html::encode(Gx::str($model->permission)), Gx::url(['permission/view', 'id' => Gx::pk($model->permission)])) : null,
			],
[
				'attribute' => 'status',
				'format' => 'raw',
