<?php
/**
 * Ported from protected/views/item/importTaxData.php.
 */
...
$this->context->menu = [
    ...
    ['label' => 'Batch Update Prices', 'url' => ['batchUpdatePrices']],
];
?>
...
<div class="form">
    ...
    <?php if (!empty($uploadError)): ?>
        <div class="alert alert-danger">
            <strong>Error:</strong> <?php echo Html::encode($uploadError); ?>
        </div>
    <?php endif; ?>
...
AIR FILTER 2 WHEELER,84212300,GST @28%</pre>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-6">
                    ...
                    <a href="<?php echo Ui::to('admin'); ?>" class="btn btn-default">
